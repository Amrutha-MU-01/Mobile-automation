...
class Test_saucelab:
    ...
    def test_add_to_cart(self):
            ...
            self.driver.find_element(AppiumBy.XPATH, saucedemo.pdt1()).click()
            time.sleep(3)
            self.driver.find_element(AppiumBy.XPATH, saucedemo.pdt2()).click()
            time.sleep(3)
    ...
    def test_validate_checkout(self,read_json):
            ...
            el4.send_keys(read_json["postalCode"])
            time.sleep(2)
