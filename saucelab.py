...
class Saucelab:
    ...
    def add_to_cart(self):
        ...
        driver.find_element(AppiumBy.XPATH,"//android.widget.EditText[@content-desc='test-First Name']").send_keys("Rahul")
        driver.find_element(AppiumBy.XPATH,"//android.widget.EditText[@content-desc='test-Last Name']").send_keys("J")
